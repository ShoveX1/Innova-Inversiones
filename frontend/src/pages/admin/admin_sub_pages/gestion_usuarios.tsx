            ...
            <div className={`${navCollapsed ? 'ml-16' : 'ml-[19rem]'} h-screen overflow-auto`}>
                <div className="bg-white shadow-md overflow-hidden flex flex-row justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm px-4 mb-2">Administración de usuarios del sistema</p>
                    </div>
                </div>
                <div className="p-4">
                    <div className="bg-gray-100 rounded-lg p-8 text-center">
                        <h2 className="text-2xl font-bold text-gray-600 mb-4">Gestión de Usuarios en construcción</h2>
