...
export default function TarjetaMetricaCliente(){
    ...
    return (
        <div className="bg-gray-100 rounded-lg  p-4">
            <section className="p-2 sm:p-4 bg-white rounded-xl">
                <div className="grid grid-cols-3 gap-4">
                    {/* Clientes Activos */}
                    <article className="bg-white border border-gray-200 rounded-lg p-2 sm:p-4 shadow-sm flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex flex-col justify-between items-center sm:items-start text-center sm:text-left">
                            <h3 className="text-gray-500 text-xs sm:text-sm">Clientes Activos</h3>
                            {loading ? (
                                <p className="text-2xl font-bold text-gray-400">...</p>
                            ) : (
                                <p className="text-xl sm:text-2xl font-bold text-black">{clientesActivos}</p>
                            )}
                        </div>
                    </article>
                    ...
                    <article className="bg-white border border-gray-200 rounded-lg p-2 sm:p-4 shadow-sm flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex flex-col justify-between items-center sm:items-start text-center sm:text-left">
                            <h3 className="text-gray-500 text-xs sm:text-sm">Clientes Prospectos</h3>
                            {loading ? (
                                <p className="text-2xl font-bold text-gray-400">...</p>
                            ) : (
                                <p className="text-xl sm:text-2xl font-bold text-black">{clientesInactivos}</p>
                            )}
                        </div>
                    </article>
                    ...
                    <article className="bg-white border border-gray-200 rounded-lg p-2 sm:p-4 shadow-sm flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex flex-col justify-between items-center sm:items-start text-center sm:text-left">
                            <h3 className="text-gray-500 text-xs sm:text-sm">Clientes Totales</h3>
                            {loading ? (
                                <p className="text-2xl font-bold text-gray-400">...</p>
                            ) : (
                                <p className="text-xl sm:text-2xl font-bold text-black">{clientesTotales}</p>
                            )}
                        </div>
                    </article>
                </div>
